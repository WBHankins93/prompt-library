...
The public library in [`02_personas/`](../02_personas/) ships general-purpose personas — archetypes designed to work for anyone, in any context. They are intentionally abstract.
...
| 👥 | **`teams/`** | Personal team compositions and routing logic. Shows how to wire specific persona stacks together for recurring contexts and projects. Teams here are opinionated about which personas activate for which situations, and why. |
...
See [`teams/team-composition.md`](teams/team-composition.md) for how it works.
...
→ [`05_personal/persona-customization-guide.md`](persona-customization-guide.md)

It walks through what to change, what not to change, and gives you a minimal template to start from.

> **The fork pattern:**
>
> 1. Pick a general persona from [`02_personas/`](../02_personas/) that fits your domain
