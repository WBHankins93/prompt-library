...
1. Baseline calibration categories
2. Exactly five persona-specific sculpting questions
3. Explicit answers defining bias and edge
4. Persona draft shaped by those answers
5. Final lock and version freeze
